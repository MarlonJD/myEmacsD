...
\(fn CMDLİNE &optional BAD GOOD ARGS)" t nil)
...
\(fn ARG &optional START-POİNT)" t nil)
...
\(fn BRANCH &optional START-POİNT)" t nil)
...
\(fn REPOSİTORY DİRECTORY ARGS)" t nil)
...
\(fn REPOSİTORY DİRECTORY ARGS DEPTH)" t nil)
...
\(fn REPOSİTORY DİRECTORY ARGS DATE)" t nil)
...
\(fn REPOSİTORY DİRECTORY ARGS EXCLUDE)" t nil)
...
\(fn &optional ARGS OVERRİDE-DATE)" t nil)
...
\(fn REV-OR-RANGE &optional ARGS FİLES)" t nil)
...
\(fn &optional REV ARGS FİLES)" t nil)
...
\(fn REV &optional ARGS FİLES MODULE)" t nil)
...
\(fn REVA REVB FİLEA FİLEB)" t nil)
...
\(fn COMMİT FİLENAME &optional LİNENUM)" t nil)
...
\(fn &optional OTHER-WİNDOW)" t nil)
...
\(fn &optional WHOAMİ FİLE-NAME OTHER-WİNDOW)" t nil)
...
\(fn &optional WHOAMİ FİLE-NAME)" t nil)
...
\(fn REVS &optional ARGS FİLES)" t nil)
...
\(fn PATTERN &optional ARGS FİLES)" t nil)
...
\(fn COMMİT BRANCH &optional ARGS FİLES)" t nil)
...
\(fn REV &optional ARGS NOCOMMİT)" t nil)
...
\(fn COMMİTS &optional ARGS)" t nil)
...
\(fn COMMİTS BRANCH &optional ARGS)" t nil)
...
\(fn COMMİTS BRANCH START-POİNT &optional ARGS)" t nil)
...
\(fn &optional FİLES ARGS)" t nil)

(autoload 'magit-am-apply-maildir "magit-sequence" "\
Apply the patches from MAILDIR.

\(fn &optional MAİLDİR ARGS)" t nil)
...
\(fn MESSAGE &optional İNCLUDE-UNTRACKED)" t nil)
...
\(fn &optional İNCLUDE-UNTRACKED)" t nil)
...
\(fn STASH &optional ARGS FİLES)" t nil)
...
\(fn &optional DİRECTORY CACHE)" t nil)
...
\(fn MODULES ARGS TRASH-GİTDİRS)" t nil)
...
\(fn PREFİX REPOSİTORY REF ARGS)" t nil)

(autoload 'magit-subtree-add-commit "magit-subtree" "\
Add COMMIT as a new subtree at PREFIX.

\(fn PREFİX COMMİT ARGS)" t nil)
...
\(fn FN L0NK DESCR0PT0ON FORMAT)" nil nil)
...
\(fn PATH BRANCH START-POİNT &optional FORCE)" t nil)
